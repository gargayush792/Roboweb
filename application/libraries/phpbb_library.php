...
class Phpbb_library
{
    ...
    public function __construct()
    {
		...
		define('FORUM_ROOT_PATH', $_SERVER['DOCUMENT_ROOT'] . '/forum/');
...
public function phpbbhash()
    {
        return $this->_user->data['is_registered'];
    }

    public function LoginUser($username, $password, $facebook ="false")
    {
        global $auth;

       return $auth->login($username, $password, "", "", "", $facebook);
    ...
    {
        return $this->db->isGroupMember('administrators');
    }
 ...
 public function addUser($data)
    {
        ...
        $user_row = array(
         ...
         'group_id'              => 2,   //2 is for newly registered users
